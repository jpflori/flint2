...
main(void)
{
    ...
    for (i = 0; i < 2000; i++)
    {
        ...
        qadic_dense_sub(c, a, b, ctx);
        qadic_dense_sub(a, a, b, ctx);
    ...
    for (i = 0; i < 2000; i++)
    {
        ...
        qadic_dense_sub(c, a, a, ctx);
        qadic_dense_sub(a, a, a, ctx);
    ...
    for (i = 0; i < 2000; i++)
    {
        ...
        qadic_dense_sub(c1, a, b, ctx);
        qadic_dense_sub(c2, b, a, ctx);
        qadic_dense_neg(c2, c2, ctx);
    ...
    for (i = 0; i < 2000; i++)
    {
        ...
        qadic_dense_randtest(a, state, ctx);
        qadic_dense_randtest(b, state, ctx);
        qadic_dense_randtest(c, state, ctx);

        qadic_dense_sub(lhs, a, b, ctx);
        qadic_dense_sub(lhs, lhs, c, ctx);
        qadic_dense_add(rhs, b, c, ctx);
        qadic_dense_sub(rhs, a, rhs, ctx);
