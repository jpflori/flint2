...
/** p > 2 ********************************************************************/
    ...
    for (i = 0; i < 1000; i++)
    {
        ...
        ans1 = qadic_dense_log_balanced(b, a, ctx);
        ans2 = qadic_dense_log_balanced(a, a, ctx);
    ...
    for (i = 0; i < 1000; i++)
    {
        ...
        qadic_dense_log_balanced(d, a, ctx);
        qadic_dense_log_balanced(e, b, ctx);
        qadic_dense_add(f, d, e, ctx);

        qadic_dense_log_balanced(g, c, ctx);
    ...
    for (i = 0; i < 1000; i++)
    {
        ...
        qadic_dense_log_balanced(c, b, ctx);
        ...
        if (!result)
        {
            ...
            printf("a =          "), qadic_dense_print_pretty(a, ctx), printf("\n");
            printf("b = exp(a) = "), qadic_dense_print_pretty(b, ctx), printf("\n");
            printf("c = log(b) = "), qadic_dense_print_pretty(c, ctx), printf("\n");
            abort();
        }
