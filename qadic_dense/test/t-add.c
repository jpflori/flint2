...
main(void)
{
    ...
    for (i = 0; i < 2000; i++)
    {
        ...
        qadic_dense_add(c1, a, b, ctx);
        qadic_dense_add(c2, b, a, ctx);
    ...
    for (i = 0; i < 2000; i++)
    {
        ...
        qadic_dense_add(lhs, a, b, ctx);
        qadic_dense_add(lhs, lhs, c, ctx);
        qadic_dense_add(rhs, b, c, ctx);
        qadic_dense_add(rhs, a, rhs, ctx);
