...
main(void)
{
    ...
    for (i = 0; i < 1000; i++)
    {
        ...
        ans1 = qadic_dense_exp_rectangular(c, b, ctx);
        ans2 = qadic_dense_exp_rectangular(b, b, ctx);
    ...
    for (i = 0; i < 1000; i++)
    {
        ...
        ans1 = qadic_dense_exp_rectangular(d, a, ctx);
        ans2 = qadic_dense_exp_rectangular(e, b, ctx);
        qadic_dense_mul(f, d, e, ctx);

        ans3 = qadic_dense_exp_rectangular(g, c, ctx);
