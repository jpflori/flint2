...
main(void)
{
    ...
    for (i = 0; i < 1000; i++)
    {
        ...
        ans1 = qadic_dense_exp_balanced(c, b, ctx);
        ans2 = qadic_dense_exp_balanced(b, b, ctx);
    ...
    for (i = 0; i < 1000; i++)
    {
        ...
        ans1 = qadic_dense_exp_balanced(d, a, ctx);
        ans2 = qadic_dense_exp_balanced(e, b, ctx);
        qadic_dense_mul(f, d, e, ctx);

        ans3 = qadic_dense_exp_balanced(g, c, ctx);
